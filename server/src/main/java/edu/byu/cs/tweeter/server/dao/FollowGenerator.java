...
public class FollowGenerator {
     ...
     * {@link #FOLLOWER_FOLLOWEE} specifies a primary sort by destination alias with a secondary sort
     * of destination alias. {@link #FOLLOWEE_FOLLOWER} specifies the opposite.
     */
    public enum Sort {
     ...
     *
     * @param users the list of users to be used to generate followMileStone3 objects.
     * @param minFollowersPerUser the minimum number of followers each user will have.
     * @param maxFollowersPerUser the maximum number of followers each user will have.
    ...
    public List<Follow> generateFollowsForUsers(List<User> users,
        ...
        // Add the test user and make him followMileStone3 everyone
